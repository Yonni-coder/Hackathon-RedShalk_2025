...
CREATE DATABASE IF NOT EXISTS `vahatra_center` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
VALUES (
        1,
        1,
        'https://unsplash.com/fr/photos/table-de-conference-en-bois-beige-_-KLkj7on_c'
    ),
    (
        2,
        2,
        'https://unsplash.com/fr/photos/table-et-chaises-de-bureau-9-pieces-en-bois-brun-1RT4txDDAbM'
    ),
    (
        3,
        1,
...
VALUES (1, 'test', NULL, NULL),
    ...
    (
        13,
        'Studio multimédia',
        'Equipé pour enregistrement',
        4
    ),
    (
        14,
        'Salle informatique',
        'Equipée avec ordinateurs',
        4
    ),
    (
        15,
...
VALUES (
        1,
        'Salle de réunion A',
        'Salle équipée pour réunions jusqu\'à 8 personnes, vidéoprojecteur et tableau blanc.',
        '8',
        'toujours',
        '2ème étage - Bâtiment B',
        NULL,
        NULL,
        NULL,
        NULL,
...
VALUES (
        ...
        'Yonni Tinogny',
        'exemple@test.com',
        '$2b$10$a3odMdXllXxNIfF46EJADO59s0CRLcdhWYGVbsj5VbJckc1wq2bFm',
        'client',
        NULL,
        1,
        '2025-08-27 15:32:22',
    ...
    (
        ...
        'Yonni Tinogny',
        'exempl2e@test.com',
        '$2b$10$9w2B6IKWYXV3R4rKQin5R.qhuu0qh9Ichbu//HIK5UgqkR3tOlZF.',
        'client',
        NULL,
        1,
        '2025-08-27 15:48:20',
    ...
    (
        ...
        'Yonni Tinogny',
        'exempl3e@test.com',
        '$2b$10$QySu3XzRd6ABTvtg6tbRqutk4kyhos0jVKimC6cXDF5738XLh8Wc.',
        'client',
        1,
        1,
        '2025-08-27 18:14:36',
    ...
    (
        ...
        'Jean Client',
        'client1@example.com',
        '$2b$10$xg.qd1.6miXvzMuqIHLADOq.HBrsQPv.yMRfF7k7YVM2dbJTPpPmW',
        'client',
        NULL,
        1,
        '2025-08-27 18:50:51',
    ...
    (
        ...
        'Paul Manager',
        'manager@vahatra.mg',
        '$2b$10$E4S1Dro2OjnODDVz2lgUKOkdz5hIu/k9HqD/X5wSSxFslyp1wj.EO',
        'manager',
        NULL,
        0,
        '2025-08-27 19:00:13',
    ...
    (
        ...
        'Marie Employée',
        'employe@vahatra.mg',
        '$2b$10$wxcqqxNY3o2X9Taiw5/tWeUmmSvlClV1KQPpXyRxklod4YW4Btccu',
        'employee',
        NULL,
        0,
        '2025-08-27 19:01:45',
    ...
    (
        ...
        'Alice Client',
        'client2@example.com',
        '$2b$10$dHBYhfrw0rRNG5hDNshCS.sn4F/cNyDQxo2pCCvv67rK/5olQZ5Uu',
        'client',
        NULL,
        1,
        '2025-08-27 19:04:30',
    ...
    (
        ...
        'Admin',
        'admin@gmail.com',
        '$2b$12$KWzrjdL3pEv3sZ1iSfhYjuC.PF8TERLcvzB5LvVdqN9j2NJ6J7EPK',
        'admin',
        NULL,
        1,
        '2025-08-27 19:32:36',
    ...
    (
        ...
        '$2b$10$DDmUjbIt2GGHjQ2rcNNcaOnEet2w85v./PD04J5f0meYtk8qhQrt.',
        'client',
        NULL,
        1,
        '2025-08-27 20:41:29',
    ...
    (
        ...
        'Paul Manager',
        'manager2@vahatra.mg',
        '$2b$10$MvIaUXEMv9EvKaYIADwEauSSiIl6NxtusFHSuuS7Nx9YoF/ygv6Wu',
        'manager',
        1,
        1,
        '2025-08-27 20:45:05',
    ...
    (
        ...
        'Paul Manager',
        'manager3@vahatra.mg',
        '$2b$10$CVfn9nm5wLO7jorL8T4HeeZiHKLhbUYSd9Z7NI3dyUqvizSx8X5Wq',
        'manager',
        1,
        1,
        '2025-08-27 21:01:23',
    ...
    (
        ...
        'Paul Manager',
        'client@vahatra.mg',
        '$2b$10$gwb7t59rUG4jgqGWaXjZt.9TS5vQZkbbrFydu3I2479KbRQ8DxWpu',
        'client',
        NULL,
        1,
        '2025-08-27 21:02:38',
    ...
    (
        ...
        'Admin',
        'admin@test.mg',
        '$2b$10$YQg6XbF1Xf1NHCjebknnWO455oVyGsn62oAMqbYAsj3Wznq592oeK',
        'admin',
        1,
        1,
        '2025-08-27 21:52:27',
    ...
    (
        ...
        'TEssss',
        'test@gmail.com',
        '$2b$10$FJUOg8VrTLBFANCu.ksY6OJ6p/BRA.EaYFDfLBuZVq4ooC0LvXwU2',
        'manager',
        1,
        1,
        '2025-08-27 23:48:30',
    ...
    (
        ...
        'TEssss',
        'tes0t@gmail.com',
        '$2b$10$USbRQgtoSdVLwHb64wbcn.oEN6AGr2xybmhsEpvdtCo0ncSfK/RpS',
        'client',
        NULL,
        1,
        '2025-08-28 06:20:47',
    ...
    (
        ...
        'TEssss',
        'testtt@gmail.com',
        '$2b$10$9tz/ukjfMKcbKx6VWA5iQud6lVlt1zZeH.6uwLD0zV.G.BMsP25PS',
        'manager',
        2,
        1,
        '2025-08-28 18:36:20',
    ...
    (
        ...
        'TEssss',
        'testttt@gmail.com',
        '$2b$10$DVhigV1FF01qcpK1uKMqMuMDXkW1BPvyIy4F9aoXFMeHcvzGtWAeq',
        'manager',
        1,
        1,
        '2025-08-28 18:43:27',
    ...
    (
        ...
        'TEssss',
        'tes7t@gmail.com',
        '$2b$10$Afys7.oqsYRbBrBDsNH6veIXfYWqJjscCgOLds203OSZW6N5iRR3W',
        'employee',
        1,
        0,
        '2025-08-28 23:30:55',
    ...
    (
        ...
        'TEssss',
        'tes8t@gmail.com',
        '$2b$10$Dw2m3EyUtuCePsfh4FMSmu2dJUI1gm.Hhz6ln/0M2ZK8sVbWrF0ya',
        'manager',
        1,
        0,
        '2025-08-28 23:33:03',
